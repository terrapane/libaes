 ...
 *
 *  Description:
 *      The AES algorithm defined in FIPS 197 specifies several predefined
 *      tables, such as the S-box and inverse S-box.  Additionally,
 *      other tables contain precomputed values that increase the efficiency
 *      of the AES encryption and decryption code.  Those tables are explained
 *      in the comments throughout the code and in the README.md file.
 *
 *  Portability Issues:
 *      None.
 */
...
//     Note that indexing is defined in the standard to start at 1, so
//     references into this array need to subtract 1 since C/C++ starts
//     indexing at 0.  Note also that different key lengths use a different
//     number of values from this array.  Specifically,
